...
/**
 * Payee组织发起创建并激活Direct Debit Mandate的操作，Customer用验证码确认，验证码使用Verification元素传递
 * 
 * <p>Java class for EnableDirectDebitMandateByPayeeRequest complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="EnableDirectDebitMandateByPayeeRequest"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "EnableDirectDebitMandateByPayeeRequest", propOrder = {
    "payer",
    "directDebitMandateInfo"
})
public class EnableDirectDebitMandateByPayeeRequest {
